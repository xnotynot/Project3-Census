// read county
var counties_infojsonFile = "./data/popincome_data.json";
var county_popinfo = []
...
function createFeatures(countyGeoData,county_popinfo) {
  ...
  function onEachFeature(feature, layer) {
    ...
    layer.bindPopup(`<h3>${feature.properties.NAME}</h3><hr><p>FIPS_ID / ${feature.properties.STATE}+${feature.properties.COUNTY}Population${popinfo.Population}</p>`)
  }
